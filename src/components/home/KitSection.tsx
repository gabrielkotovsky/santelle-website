...
import { ContentImage } from '../shared/OptimizedImage';
  ...
  return (
    <>
      ...
      <section id="kit" className="hidden md:flex w-full min-h-screen h-screen items-center justify-center">
          <div className="bg-white/30 backdrop-blur-lg rounded-3xl shadow-none flex flex-col md:flex-row items-center justify-center gap-2 md:gap-0 border border-white/50" style={{height: '95vh', width: '95vw', padding: '120px'}}>
